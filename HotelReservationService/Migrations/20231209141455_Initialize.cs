        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    totalroomnumber = table.Column<int>(name: "total_room_number", type: "int", nullable: false),
                    fullroomnumber = table.Column<int>(name: "full_room_number", type: "int", nullable: true),
                    overallscore = table.Column<float>(name: "overall_score", type: "real", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    hasBeach = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    HotelId = table.Column<int>(type: "int", nullable: false),
                    PicUrl = table.Column<string>(name: "Pic_Url", type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalGuestNumber = table.Column<int>(name: "Total_Guest_Number", type: "int", nullable: false),
